...
1. Create a Agent in [Copilot Studio](https://copilotstudio.microsoft.com)
   ...
   1. Go to **Settings** => **Advanced** => **Metadata** and note the following values:
      1. Schema name
      1. Environment Id
   1. Set the Copilot Studio Agent information in appsettings.example.json and rename to appsettings.json.
...
With the above information, you can now run the client `ConsoleCopilotStudio`.
